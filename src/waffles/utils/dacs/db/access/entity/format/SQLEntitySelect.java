...
/**
 * An {@code SQLEntitySelect} selects a {@code DBEntity} from a {@code DBTable}.
 *
 * @author Waffles
 * @since 03 Nov 2025
 * @version 1.1
 ...
 * @see DBEntity
 */
public class SQLEntitySelect implements SQLFormat<DBEntity<?>>
{
	private DBTable<?> tbl;
	
	/**
	 * Creates a new {@code SQLEntitySelect}.
	 * 
	 ...
	 * @see DBTable
	 */
	public SQLEntitySelect(DBTable<?> t)
	{
		tbl = t;
	}
